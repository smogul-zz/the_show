...
import 'package:the_show/dashing_board.dart';
...
class _LoginPageState extends State<LoginPage> {
  ...
  Future<void> clickOnLogin(BuildContext context) async {
    if (_contactEditingController.text.isEmpty) {
      ...
      final responseMessage = await Navigator.pushNamed(context, '/otpPage',
          ...
          child: Container(
            ...
            child: Column(
              ...
              children: [
                ...
                const Text(
                  'Please enter mobile number to verify',
